...
// export const getLeadAcitivities = async (leadId: number): Promise<NotesLog[]> => {
//   try {
//     const response = await axiosInstance.get(`/lead-activity/${leadId}`);
//     console.log("get acitivites===============>", response);
